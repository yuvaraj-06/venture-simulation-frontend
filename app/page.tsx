...
export default async function HomePage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#F1F4F5', padding: '0' }}>
      {/* Header */}
      <div style={{ borderBottom: '1px solid #E8E6E4', padding: '20px 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <span style={{ color: '#111111', fontWeight: 600, fontSize: 18 }}>ShareOS</span>
          <span style={{ color: '#939799', margin: '0 4px' }}>/</span>
          <span style={{ color: '#5E6366', fontSize: 16 }}>Venture Simulations</span>
        </div>
      ...
      <div style={{ padding: '80px 40px 60px', maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 8 }}>
          <span style={{
            ...
            border: '1px solid rgba(10, 125, 60, 0.3)',
        ...
        <h1 style={{ fontSize: 56, fontWeight: 800, lineHeight: 1.1, marginBottom: 20, letterSpacing: '-0.02em' }}>
          Venture<br />
          <span style={{ color: '#0A7D3C' }}>Simulation</span> Engine
        </h1>
        <p style={{ color: '#5E6366', fontSize: 18, maxWidth: 600, lineHeight: 1.7, marginBottom: 40 }}>
        ...
        <div style={{ display: 'flex', gap: 40, marginBottom: 60 }}>
          {[
            ...
            <div key={s.label}>
              <div style={{ fontSize: 32, fontWeight: 800, color: '#0A7D3C' }}>{s.value}</div>
              <div style={{ color: '#939799', fontSize: 13 }}>{s.label}</div>
            </div>
          ))}
        </div>

        <hr style={{ border: 'none', borderTop: '1px solid #E8E6E4', marginBottom: 60 }} />

        {/* Simulations Grid */}
        {simulations.length === 0 ? (
          <div style={{
            textAlign: 'center', padding: '80px 40px',
            border: '1px dashed #E8E6E4', borderRadius: 12
          }}>
            <div style={{ fontSize: 48, marginBottom: 16 }}>🤖</div>
            <div style={{ color: '#5E6366', fontSize: 18, marginBottom: 8 }}>No simulations yet</div>
            <div style={{ color: '#939799', fontSize: 14 }}>
              Run <code style={{ background: '#FFFFFF', padding: '2px 8px', borderRadius: 4, color: '#0A7D3C' }}>
          ...
          <div>
            <div style={{ color: '#939799', fontSize: 13, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 24 }}>
              Active Simulations
            </div>
      ...
      {/* Footer */}
      <div style={{ borderTop: '1px solid #FFFFFF', padding: '24px 40px', marginTop: 80, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
